...
namespace pacman
{
	...
	private:
		...
		std::unique_ptr<dae::GameObject> CreateGhost(const glm::vec2& spawnPos, const std::string& spritefile, dae::GameObject* targetObj, std::unique_ptr<GhostState> state);
